...
# - openrouter (Responses API; requires OPENROUTER_API_KEY)
...
# Select "OpenRouter Free" from the model picker. The provider and virtual
# openrouter/free-max model are persisted automatically.
